...
### Сценарий 2. UDP уходит мимо прокси — деанон
...
4. STUN видит настоящий адрес — `203.0.113.42` — и возвращает его как srflx-кандидата.
5. Скрипт сравнивает: `203.0.113.42` ≠ `198.51.100.7`. Прокси обнаружен, настоящий IP получен.
