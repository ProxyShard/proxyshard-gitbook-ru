...
| [Поддержка UDP](../about-udp/) | ✓ (кроме США; есть [ограничения по портам](../restrictions.md)) | ✓ (кроме США; есть [ограничения по портам](../restrictions.md)) | ✓ ([кроме отдельных городов и устройств macOS/iOS](../restrictions.md)) |
