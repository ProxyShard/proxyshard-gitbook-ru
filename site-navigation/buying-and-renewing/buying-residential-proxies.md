...
После оплаты откроется панель настройки и генерации прокси. Описание параметров заказа доступно в [разделе о резидентских прокси](../../our-products/residential-proxies/#nastroika-proksi).
